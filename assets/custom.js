/*
 *Flexy HTML5 Multipurpose Theme v1.1
...
$(document).ready(function() {
  ...
  // Auto typing init
  $(".typed").typed({
    strings: ["multifunctional business theme", "Fully responsive", "7 different Landing Pages", "Perfect for sturtups", "Hostings", "Web Apps", "and more..."],
